...
public class JamExpandListAdapter extends BaseExpandableListAdapter {
    ...
    public JamExpandListAdapter(Context context, ArrayList<TakeStoclListBean> listDataHeader,
